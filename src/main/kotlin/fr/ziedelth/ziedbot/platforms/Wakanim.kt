...
class Wakanim : Platform {
    ...
    private fun getEpisodes(): Array<Episode> {
        ...
        try {
            driver.get("https://www.wakanim.tv/fr/v2/agenda")
                ...
                if (linkElement != null) {
                    ...
                    if (!time.isNullOrEmpty()) {
                        ...
                        if (calendar.after(releaseDate)) {
                            ...
                            val episodeType = if (ltype.equals("VOSTFR")) EpisodeType.SUBTITLES else EpisodeType.VOICE
